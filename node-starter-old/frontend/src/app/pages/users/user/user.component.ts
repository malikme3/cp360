...
export class UserComponent implements OnInit, OnDestroy {
  ...
  get zipCode3() {
    return this.userForm.get('address').get('zipCode3');
  }
    ...
    loadUser.pipe(takeUntil(this.unsubscribe$)).subscribe(user => {
      this.userForm.setValue({
        ...
        address: {
          ...
          zipCode3: user.address && user.address.zipCode3 ? user.address.zipCode3 : '',
        },
      });
  ...
  save() {
    ...
    console.log('Testing testing teating ');
    // tslint:disable-next-line:no-console
    console.log('Testing testing teating: ' + JSON.stringify(user));
